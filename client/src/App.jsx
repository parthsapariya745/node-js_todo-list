      ...
      <div className="w-full max-w-[480px] bg-zinc-800 shadow-lg rounded-2xl p-6 border border-zinc-700">
        ...
        <div className="btn flex sm:flex-row flex-col gap-2 mb-4">
          ...
          <div class="btn flex gap-2">
            <button className="px-4 py-2 sm:w-auto w-full cursor-pointer bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition">Add</button>
            <button className="px-4 py-2 sm:w-auto w-full cursor-pointer bg-rose-600 text-white rounded-xl hover:bg-rose-700 transition">Clear All</button>
          </div>
        </div>
          ...
          {/* {todos.map((todo, i) => (
            <li key={i} className="flex items-center justify-between px-4 py-2 border border-zinc-600 rounded-xl bg-zinc-700 hover:bg-zinc-600">
              ...
              <div className="flex items-center gap-2">
                <button className="px-3 py-1.5 cursor-pointer text-white text-sm rounded-lg transition bg-blue-600 hover:bg-blue-700">Edit</button>
                <button className="px-3 py-1.5 cursor-pointer text-white text-sm rounded-lg transition bg-red-600 hover:bg-red-700">Delete</button>
              </div>
            </li>
          ))} */}
        </ul>
